...
@interface wikiModelController()
@property (readonly, strong, nonatomic) NSArray *pageData;
@end

@implementation wikiModelController
...
{   
    ...
    wikiDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"wikiDataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(wikiDataViewController *)viewController];
